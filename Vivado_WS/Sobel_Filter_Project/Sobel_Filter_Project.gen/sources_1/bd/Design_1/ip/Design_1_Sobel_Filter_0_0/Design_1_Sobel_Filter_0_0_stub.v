...
//               c:/F.A.L.C.O.N/Vivado_WS/Sobel_Filter_Project/Sobel_Filter_Project.gen/sources_1/bd/Design_1/ip/Design_1_Sobel_Filter_0_0/Design_1_Sobel_Filter_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "Design_1_Sobel_Filter_0_0,Sobel_Filter,{}" *) (* CORE_GENERATION_INFO = "Design_1_Sobel_Filter_0_0,Sobel_Filter,{x_ipProduct=Vivado 2026.1,x_ipVendor=xilinx.com,x_ipLibrary=hls,x_ipName=Sobel_Filter,x_ipVersion=1.0,x_ipCoreRevision=2114797568,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_S_AXI_CONTROL_ADDR_WIDTH=5,C_S_AXI_CONTROL_DATA_WIDTH=32}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "HLS" *) (* X_CORE_INFO = "Sobel_Filter,Vivado 2026.1" *) (* hls_module = "yes" *) 
module Design_1_Sobel_Filter_0_0(s_axi_control_ARADDR, 
