...
#define XSOBEL_FILTER_CONTROL_ADDR_ROWS_DATA 0x10
#define XSOBEL_FILTER_CONTROL_BITS_ROWS_DATA 32
#define XSOBEL_FILTER_CONTROL_ADDR_COLS_DATA 0x18
#define XSOBEL_FILTER_CONTROL_BITS_COLS_DATA 32
