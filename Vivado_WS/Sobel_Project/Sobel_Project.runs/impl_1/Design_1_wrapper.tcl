namespace eval ::optrace {
  variable script "C:/Vivado_WS/Sobel_Project/Sobel_Project.runs/impl_1/Design_1_wrapper.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/Vivado_WS/Sobel_Project/Sobel_Project.cache/wt [current_project]
  set_property parent.project_path C:/Vivado_WS/Sobel_Project/Sobel_Project.xpr [current_project]
  set_property ip_repo_paths C:/Vitis_WS/Sobel_IP/Sobel_IP [current_project]
  update_ip_catalog
  set_property ip_output_repo C:/Vivado_WS/Sobel_Project/Sobel_Project.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/Vivado_WS/Sobel_Project/Sobel_Project.runs/synth_1/Design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -limit 0
  set_param project.isImplRun true
  add_files C:/Vivado_WS/Sobel_Project/Sobel_Project.srcs/sources_1/bd/Design_1/Design_1.bd
