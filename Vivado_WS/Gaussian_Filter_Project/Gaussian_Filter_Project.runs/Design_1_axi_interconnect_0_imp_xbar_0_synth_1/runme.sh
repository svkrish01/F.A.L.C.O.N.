...
HD_PWD='C:/F.A.L.C.O.N/Vivado_WS/Gaussian_Filter_Project/Gaussian_Filter_Project.runs/Design_1_axi_interconnect_0_imp_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Design_1_axi_interconnect_0_imp_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Design_1_axi_interconnect_0_imp_xbar_0.tcl
