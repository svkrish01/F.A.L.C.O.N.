...
// ==============================================================
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module Gaussian_Filter_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IER         = 5'h08,
    ADDR_ISR         = 5'h0c,
    ADDR_ROWS_DATA_0 = 5'h10,
    ADDR_ROWS_CTRL   = 5'h14,
    ADDR_COLS_DATA_0 = 5'h18,
    ADDR_COLS_CTRL   = 5'h1c,
    WRIDLE           = 2'd0,
    WRDATA           = 2'd1,
    WRRESP           = 2'd2,
    WRRESET          = 2'd3,
