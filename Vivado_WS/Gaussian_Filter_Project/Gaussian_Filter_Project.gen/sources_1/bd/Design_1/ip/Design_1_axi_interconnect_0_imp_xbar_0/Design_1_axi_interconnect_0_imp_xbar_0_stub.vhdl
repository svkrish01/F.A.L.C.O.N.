...
--               c:/F.A.L.C.O.N/Vivado_WS/Gaussian_Filter_Project/Gaussian_Filter_Project.gen/sources_1/bd/Design_1/ip/Design_1_axi_interconnect_0_imp_xbar_0/Design_1_axi_interconnect_0_imp_xbar_0_stub.vhdl
...
entity Design_1_axi_interconnect_0_imp_xbar_0 is
  ...
  attribute CORE_GENERATION_INFO of Design_1_axi_interconnect_0_imp_xbar_0 : entity is "Design_1_axi_interconnect_0_imp_xbar_0,axi_crossbar_v2_1_39_axi_crossbar,{x_ipProduct=Vivado 2026.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=axi_crossbar,x_ipVersion=2.1,x_ipCoreRevision=39,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,C_FAMILY=zynq,C_NUM_SLAVE_SLOTS=2,C_NUM_MASTER_SLOTS=2,C_AXI_ID_WIDTH=1,C_AXI_ADDR_WIDTH=32,C_AXI_DATA_WIDTH=64,C_AXI_PROTOCOL=1,C_NUM_ADDR_RANGES=1,C_M_AXI_BASE_ADDR=0xffffffffffffffff0000000000000000,C_M_AXI_ADDR_WIDTH=0x000000000000001D,C_S_AXI_BASE_ID=0x0000000100000000,C_S_AXI_THREAD_ID_WIDTH=0x0000000000000000,C_AXI_SUPPORTS_USER_SIGNALS=0,C_AXI_AWUSER_WIDTH=1,C_AXI_ARUSER_WIDTH=1,C_AXI_WUSER_WIDTH=1,C_AXI_RUSER_WIDTH=1,C_AXI_BUSER_WIDTH=1,C_M_AXI_WRITE_CONNECTIVITY=0x0000000200000002,C_M_AXI_READ_CONNECTIVITY=0x0000000100000001,C_R_REGISTER=0,C_S_AXI_SINGLE_THREAD=0x0000000000000000,C_S_AXI_WRITE_ACCEPTANCE=0x0000001000000002,C_S_AXI_READ_ACCEPTANCE=0x0000000200000010,C_M_AXI_WRITE_ISSUING=0x0000000800000008,C_M_AXI_READ_ISSUING=0x0000000800000008,C_S_AXI_ARB_PRIORITY=0x0000000000000000,C_M_AXI_SECURE=0x0000000000000000,C_CONNECTIVITY_MODE=1}";
...
architecture stub of Design_1_axi_interconnect_0_imp_xbar_0 is
  attribute syn_black_box : boolean;
  attribute black_box_pad_pin : string;
  attribute syn_black_box of stub : architecture is true;
  attribute black_box_pad_pin of stub : architecture is "aclk,aresetn,s_axi_awid[1:0],s_axi_awaddr[63:0],s_axi_awlen[7:0],s_axi_awsize[5:0],s_axi_awburst[3:0],s_axi_awlock[3:0],s_axi_awcache[7:0],s_axi_awprot[5:0],s_axi_awqos[7:0],s_axi_awvalid[1:0],s_axi_awready[1:0],s_axi_wid[1:0],s_axi_wdata[127:0],s_axi_wstrb[15:0],s_axi_wlast[1:0],s_axi_wvalid[1:0],s_axi_wready[1:0],s_axi_bid[1:0],s_axi_bresp[3:0],s_axi_bvalid[1:0],s_axi_bready[1:0],s_axi_arid[1:0],s_axi_araddr[63:0],s_axi_arlen[7:0],s_axi_arsize[5:0],s_axi_arburst[3:0],s_axi_arlock[3:0],s_axi_arcache[7:0],s_axi_arprot[5:0],s_axi_arqos[7:0],s_axi_arvalid[1:0],s_axi_arready[1:0],s_axi_rid[1:0],s_axi_rdata[127:0],s_axi_rresp[3:0],s_axi_rlast[1:0],s_axi_rvalid[1:0],s_axi_rready[1:0],m_axi_awid[1:0],m_axi_awaddr[63:0],m_axi_awlen[7:0],m_axi_awsize[5:0],m_axi_awburst[3:0],m_axi_awlock[3:0],m_axi_awcache[7:0],m_axi_awprot[5:0],m_axi_awqos[7:0],m_axi_awvalid[1:0],m_axi_awready[1:0],m_axi_wid[1:0],m_axi_wdata[127:0],m_axi_wstrb[15:0],m_axi_wlast[1:0],m_axi_wvalid[1:0],m_axi_wready[1:0],m_axi_bid[1:0],m_axi_bresp[3:0],m_axi_bvalid[1:0],m_axi_bready[1:0],m_axi_arid[1:0],m_axi_araddr[63:0],m_axi_arlen[7:0],m_axi_arsize[5:0],m_axi_arburst[3:0],m_axi_arlock[3:0],m_axi_arcache[7:0],m_axi_arprot[5:0],m_axi_arqos[7:0],m_axi_arvalid[1:0],m_axi_arready[1:0],m_axi_rid[1:0],m_axi_rdata[127:0],m_axi_rresp[3:0],m_axi_rlast[1:0],m_axi_rvalid[1:0],m_axi_rready[1:0]";
  ...
  attribute X_CORE_INFO of stub : architecture is "axi_crossbar_v2_1_39_axi_crossbar,Vivado 2026.1";
begin
end;
