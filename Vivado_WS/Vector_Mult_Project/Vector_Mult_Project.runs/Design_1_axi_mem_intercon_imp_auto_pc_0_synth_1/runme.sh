...
HD_PWD='C:/Vivado_WS/Vector_Mult_Project/Vector_Mult_Project.runs/Design_1_axi_mem_intercon_imp_auto_pc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Design_1_axi_mem_intercon_imp_auto_pc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Design_1_axi_mem_intercon_imp_auto_pc_0.tcl
