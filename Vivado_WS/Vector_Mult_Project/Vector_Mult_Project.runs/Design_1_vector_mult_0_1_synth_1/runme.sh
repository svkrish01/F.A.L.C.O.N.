...
HD_PWD='C:/Vivado_WS/Vector_Mult_Project/Vector_Mult_Project.runs/Design_1_vector_mult_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Design_1_vector_mult_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Design_1_vector_mult_0_1.tcl
