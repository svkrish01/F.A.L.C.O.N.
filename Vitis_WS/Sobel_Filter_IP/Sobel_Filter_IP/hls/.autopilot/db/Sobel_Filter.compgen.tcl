...
set name Sobel_Filter_mul_31ns_31ns_62_2_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 21 \
			corename Sobel_Filter_control_axilite \
			name Sobel_Filter_control_s_axi \
			ports {$port_control} \
			op interface \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Sobel_Filter_control_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Sobel_Filter_regslice_both BINDTYPE {interface} TYPE {adapter} IMPL {reg_slice}
}
