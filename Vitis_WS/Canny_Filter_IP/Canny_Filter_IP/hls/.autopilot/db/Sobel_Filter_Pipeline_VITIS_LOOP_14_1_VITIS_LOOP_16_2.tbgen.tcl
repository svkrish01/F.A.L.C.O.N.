set moduleName Sobel_Filter_Pipeline_VITIS_LOOP_14_1_VITIS_LOOP_16_2
set isTopModule 0
...
set cdfgNum 12
set C_modelName {Sobel_Filter_Pipeline_VITIS_LOOP_14_1_VITIS_LOOP_16_2}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ Cols_2 int 32 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "Cols_2", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ Gaussian_to_Sobel_dout sc_in sc_lv 32 signal 1 } 
	{ Gaussian_to_Sobel_empty_n sc_in sc_logic 1 signal 1 } 
	{ Gaussian_to_Sobel_read sc_out sc_logic 1 signal 1 } 
	{ Gaussian_to_Sobel_num_data_valid sc_in sc_lv 4 signal 1 } 
	{ Gaussian_to_Sobel_fifo_cap sc_in sc_lv 4 signal 1 } 
	{ Sobel_to_Suppression_din sc_out sc_lv 32 signal 2 } 
	{ Sobel_to_Suppression_full_n sc_in sc_logic 1 signal 2 } 
	{ Sobel_to_Suppression_write sc_out sc_logic 1 signal 2 } 
	{ Sobel_to_Suppression_num_data_valid sc_in sc_lv 4 signal 2 } 
	{ Sobel_to_Suppression_fifo_cap sc_in sc_lv 4 signal 2 } 
	{ Cols_2 sc_in sc_lv 32 signal 0 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "Cols_2", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "Cols_2", "role": "default" }} , 
...
set Spec2ImplPortList { 
	Cols_2 { ap_none {  { Cols_2 in_data 0 32 } } }
