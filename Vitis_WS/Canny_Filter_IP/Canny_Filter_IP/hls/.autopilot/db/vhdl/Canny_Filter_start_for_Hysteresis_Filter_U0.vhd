...
entity Canny_Filter_start_for_Hysteresis_Filter_U0 is 
    generic (
...
architecture rtl of Canny_Filter_start_for_Hysteresis_Filter_U0 is
...
------------------------Component----------------------
    component Canny_Filter_start_for_Hysteresis_Filter_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
...
begin
----------------------- Instantiation -----------------------
    U_Canny_Filter_start_for_Hysteresis_Filter_U0_ShiftReg : Canny_Filter_start_for_Hysteresis_Filter_U0_ShiftReg
    generic map (
...
entity Canny_Filter_start_for_Hysteresis_Filter_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 4);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end Canny_Filter_start_for_Hysteresis_Filter_U0_ShiftReg;

architecture rtl of Canny_Filter_start_for_Hysteresis_Filter_U0_ShiftReg is
