...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Canny_Filter_sparsemux_7_2_1_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {onehotencoding_realdef}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { Output_Stream_TVALID { O 1 bit } Output_Stream_TDEST { O 6 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln70 \
    op interface \
    ports { add_ln70 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 69 \
    name High_Threshold_1 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_High_Threshold_1 \
    op interface \
    ports { High_Threshold_1 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    id 70 \
    name Low_Threshold_1 \
    type other \
    dir I \
    reset_level 1 \
    sync_rst true \
    corename dc_Low_Threshold_1 \
    op interface \
    ports { Low_Threshold_1 { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_add_ln70_1 \
    op interface \
    ports { add_ln70_1 { I 32 vector } } \
} "
}
