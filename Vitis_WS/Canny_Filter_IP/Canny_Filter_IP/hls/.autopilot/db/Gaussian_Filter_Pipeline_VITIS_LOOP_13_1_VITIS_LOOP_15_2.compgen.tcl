...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler Canny_Filter_Gaussian_Filter_Pipeline_VITIS_LOOP_13_1_VITIS_LOOP_15_2_Line_Buffer_1_RAM_AUbkb BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { Input_Stream_TREADY { O 1 bit } Input_Stream_TDEST { I 6 vector } } \
} "
} else {
