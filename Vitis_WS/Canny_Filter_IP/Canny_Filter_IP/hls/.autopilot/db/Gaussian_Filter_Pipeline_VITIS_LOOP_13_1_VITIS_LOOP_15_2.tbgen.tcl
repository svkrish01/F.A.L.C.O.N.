set moduleName Gaussian_Filter_Pipeline_VITIS_LOOP_13_1_VITIS_LOOP_15_2
set isTopModule 0
...
set cdfgNum 12
set C_modelName {Gaussian_Filter_Pipeline_VITIS_LOOP_13_1_VITIS_LOOP_15_2}
...
set portList { 
	...
	{ Gaussian_to_Sobel_din sc_out sc_lv 32 signal 8 } 
	{ Gaussian_to_Sobel_full_n sc_in sc_logic 1 signal 8 } 
	{ Gaussian_to_Sobel_write sc_out sc_logic 1 signal 8 } 
	{ Gaussian_to_Sobel_num_data_valid sc_in sc_lv 4 signal 8 } 
	{ Gaussian_to_Sobel_fifo_cap sc_in sc_lv 4 signal 8 } 
	...
	{ Input_Stream_TUSER sc_in sc_lv 3 signal 4 } 
	{ Input_Stream_TLAST sc_in sc_lv 1 signal 5 } 
	{ Input_Stream_TID sc_in sc_lv 5 signal 6 } 
	{ Input_Stream_TDEST sc_in sc_lv 6 signal 7 } 
	{ bound sc_in sc_lv 62 signal 9 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	...
	Input_Stream_V_dest_V { axis {  { Input_Stream_TREADY in_acc 1 1 }  { Input_Stream_TDEST in_data 0 6 } } }
