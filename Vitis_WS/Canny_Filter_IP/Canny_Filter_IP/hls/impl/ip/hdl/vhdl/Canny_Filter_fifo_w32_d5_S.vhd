...
entity Canny_Filter_fifo_w32_d5_S is 
    generic (
...
architecture rtl of Canny_Filter_fifo_w32_d5_S is
...
------------------------Component----------------------
    component Canny_Filter_fifo_w32_d5_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 5);
...
begin
----------------------- Instantiation -----------------------
    U_Canny_Filter_fifo_w32_d5_S_ShiftReg : Canny_Filter_fifo_w32_d5_S_ShiftReg
    generic map (
...
entity Canny_Filter_fifo_w32_d5_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 32;
        ADDR_WIDTH : integer := 3;
        DEPTH      : integer := 5);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end Canny_Filter_fifo_w32_d5_S_ShiftReg;

architecture rtl of Canny_Filter_fifo_w32_d5_S_ShiftReg is
