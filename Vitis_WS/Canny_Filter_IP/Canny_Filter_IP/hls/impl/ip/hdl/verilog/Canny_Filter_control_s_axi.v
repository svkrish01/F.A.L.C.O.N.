...
// ==============================================================
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module Canny_Filter_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_HIGH_THRESHOLD_DATA_0 = 6'h20,
    ADDR_HIGH_THRESHOLD_CTRL   = 6'h24,
    ADDR_LOW_THRESHOLD_DATA_0  = 6'h28,
    ADDR_LOW_THRESHOLD_CTRL    = 6'h2c,
    WRIDLE                     = 2'd0,
    WRDATA                     = 2'd1,
    WRRESP                     = 2'd2,
    WRRESET                    = 2'd3,
...
assign High_Threshold    = int_High_Threshold;
assign Low_Threshold     = int_Low_Threshold;
// int_interrupt
always @(posedge ACLK) begin
    if (ARESET)
        int_interrupt <= 1'b0;
