...
module Canny_Filter_entry_proc (
        ap_clk,
        ap_rst,
        ap_start,
        start_full_n,
...
input  [3:0] High_Threshold_c_num_data_valid;
input  [3:0] High_Threshold_c_fifo_cap;
input  [31:0] Low_Threshold;
output  [31:0] Low_Threshold_c_din;
input   Low_Threshold_c_full_n;
output   Low_Threshold_c_write;
input  [3:0] Low_Threshold_c_num_data_valid;
input  [3:0] Low_Threshold_c_fifo_cap;
...
always @ (*) begin
    ap_block_state1 = ((real_start == 1'b0) | (1'b0 == Low_Threshold_c_full_n) | (1'b0 == High_Threshold_c_full_n) | (ap_done_reg == 1'b1));
end
...
endmodule //Canny_Filter_entry_proc
