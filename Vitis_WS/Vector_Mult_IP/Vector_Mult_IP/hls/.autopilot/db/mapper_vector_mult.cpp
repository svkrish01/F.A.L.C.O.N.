...
using hls::sim::Byte;
extern "C" void vector_mult(Byte<4>*, Byte<4>*, Byte<4>*, long long, long long, long long, int);
extern "C" void apatb_vector_mult_hw(volatile void * __xlx_apatb_param_A, volatile void * __xlx_apatb_param_B, volatile void * __xlx_apatb_param_C, int __xlx_apatb_param_length_r) {
...
__xlx_A__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_A)[i]);
  ...
  int __xlx_size_param_A = 1000000;
...
__xlx_B__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_B)[i]);
  ...
  int __xlx_size_param_B = 1000000;
...
__xlx_C__tmp_vec.push_back(((Byte<4>*)__xlx_apatb_param_C)[i]);
  ...
  int __xlx_size_param_C = 1000000;
  int __xlx_offset_param_C = 0;
  int __xlx_offset_byte_param_C = 0*4;
  // DUT call
  vector_mult(__xlx_A__tmp_vec.data(), __xlx_B__tmp_vec.data(), __xlx_C__tmp_vec.data(), __xlx_offset_byte_param_A, __xlx_offset_byte_param_B, __xlx_offset_byte_param_C, __xlx_apatb_param_length_r);
