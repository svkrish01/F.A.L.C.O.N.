...
entity vector_mult_control_s_axi is
generic (
...
end entity vector_mult_control_s_axi;
...
architecture behave of vector_mult_control_s_axi is
...
attribute DowngradeIPIdentifiedWarnings of behave : architecture is "yes";
    ...
    constant ADDR_LENGTH_R_DATA_0 : INTEGER := 16#34#;
    constant ADDR_LENGTH_R_CTRL   : INTEGER := 16#38#;
...
-- ----------------------- Register logic ----------------
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ARESET = '1') then
                int_length_r(31 downto 0) <= (others => '0');
            elsif (ACLK_EN = '1') then
