...
auto* sOutput_V_dest_V = createStream((hls::stream<char>*)__xlx_apatb_param_Output_V_dest_V);
  // DUT call
  Gaussian_Filter(sInput_V_data_V->data<int>(), sInput_V_keep_V->data<char>(), sInput_V_strb_V->data<char>(), sInput_V_user_V->data<char>(), sInput_V_last_V->data<char>(), sInput_V_id_V->data<char>(), sInput_V_dest_V->data<char>(), sOutput_V_data_V->data<int>(), sOutput_V_keep_V->data<char>(), sOutput_V_strb_V->data<char>(), sOutput_V_user_V->data<char>(), sOutput_V_last_V->data<char>(), sOutput_V_id_V->data<char>(), sOutput_V_dest_V->data<char>(), __xlx_apatb_param_Rows, __xlx_apatb_param_Cols);
