...
void XSobel_filter_Set_rows(XSobel_filter *InstancePtr, u32 Data) {
    ...
    XSobel_filter_WriteReg(InstancePtr->Control_BaseAddress, XSOBEL_FILTER_CONTROL_ADDR_ROWS_DATA, Data);
}
...
u32 XSobel_filter_Get_rows(XSobel_filter *InstancePtr) {
    ...
    Data = XSobel_filter_ReadReg(InstancePtr->Control_BaseAddress, XSOBEL_FILTER_CONTROL_ADDR_ROWS_DATA);
    return Data;
}
...
void XSobel_filter_Set_cols(XSobel_filter *InstancePtr, u32 Data) {
    ...
    XSobel_filter_WriteReg(InstancePtr->Control_BaseAddress, XSOBEL_FILTER_CONTROL_ADDR_COLS_DATA, Data);
}
...
u32 XSobel_filter_Get_cols(XSobel_filter *InstancePtr) {
    ...
    Data = XSobel_filter_ReadReg(InstancePtr->Control_BaseAddress, XSOBEL_FILTER_CONTROL_ADDR_COLS_DATA);
    return Data;
}
