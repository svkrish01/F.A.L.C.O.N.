; ModuleID = 'C:/Vitis_WS/Sobel_IP/Sobel_IP/hls/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>" = type { %"struct.hls::axis<ap_int<32>, 2, 5, 6>" }
...
define void @apatb_sobel_filter_ir(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull align 4 dereferenceable(12) %input, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull align 4 dereferenceable(12) %output, i32 %rows, i32 %cols) local_unnamed_addr #0 {
entry:
  %input_copy.data = alloca i32, align 512
  %input_copy.keep = alloca i4, align 512
  %input_copy.strb = alloca i4, align 512
  %input_copy.user = alloca i2, align 512
  ...
  %output_copy.user = alloca i2, align 512
  %output_copy.last = alloca i1, align 512
  %output_copy.id = alloca i5, align 512
  %output_copy.dest = alloca i6, align 512
  call fastcc void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* nonnull %input, i32* nonnull align 512 %input_copy.data, i4* nonnull align 512 %input_copy.keep, i4* nonnull align 512 %input_copy.strb, i2* nonnull align 512 %input_copy.user, i1* nonnull align 512 %input_copy.last, i5* nonnull align 512 %input_copy.id, i6* nonnull align 512 %input_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* nonnull %output, i32* nonnull align 512 %output_copy.data, i4* nonnull align 512 %output_copy.keep, i4* nonnull align 512 %output_copy.strb, i2* nonnull align 512 %output_copy.user, i1* nonnull align 512 %output_copy.last, i5* nonnull align 512 %output_copy.id, i6* nonnull align 512 %output_copy.dest)
  call void @apatb_sobel_filter_hw(i32* %input_copy.data, i4* %input_copy.keep, i4* %input_copy.strb, i2* %input_copy.user, i1* %input_copy.last, i5* %input_copy.id, i6* %input_copy.dest, i32* %output_copy.data, i4* %output_copy.keep, i4* %output_copy.strb, i2* %output_copy.user, i1* %output_copy.last, i5* %output_copy.id, i6* %output_copy.dest, i32 %rows, i32 %cols)
  call void @copy_back(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %input, i32* %input_copy.data, i4* %input_copy.keep, i4* %input_copy.strb, i2* %input_copy.user, i1* %input_copy.last, i5* %input_copy.id, i6* %input_copy.dest, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %output, i32* %output_copy.data, i4* %output_copy.keep, i4* %output_copy.strb, i2* %output_copy.user, i1* %output_copy.last, i5* %output_copy.id, i6* %output_copy.dest)
  ret void
}
...
entry:
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>.52"(i32* align 512 %_V_data_V, i4* align 512 %_V_keep_V, i4* align 512 %_V_strb_V, i2* align 512 %_V_user_V, i1* align 512 %_V_last_V, i5* align 512 %_V_id_V, i6* align 512 %_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %0)
  call fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>.52"(i32* align 512 %_V_data_V1, i4* align 512 %_V_keep_V2, i4* align 512 %_V_strb_V3, i2* align 512 %_V_user_V4, i1* align 512 %_V_last_V5, i5* align 512 %_V_id_V6, i6* align 512 %_V_dest_V7, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %1)
  ret void
}
...
copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>.47"(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* nonnull %dst, i32* align 512 %src_V_data_V, i4* align 512 %src_V_keep_V, i4* align 512 %src_V_strb_V, i2* align 512 %src_V_user_V, i1* align 512 %src_V_last_V, i5* align 512 %src_V_id_V, i6* align 512 %src_V_dest_V)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>.47"(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nocapture, i32* noalias nocapture align 512 "unpacked"="1.0" %_V_data_V, i4* noalias nocapture align 512 "unpacked"="1.1" %_V_keep_V, i4* noalias nocapture align 512 "unpacked"="1.2" %_V_strb_V, i2* noalias nocapture align 512 "unpacked"="1.3" %_V_user_V, i1* noalias nocapture align 512 "unpacked"="1.4" %_V_last_V, i5* noalias nocapture align 512 "unpacked"="1.5" %_V_id_V, i6* noalias nocapture align 512 "unpacked"="1.6" %_V_dest_V) unnamed_addr #4 {
entry:
  %1 = alloca i32
  %2 = alloca i4
  %3 = alloca i4
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"onebyonecpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>.52"(i32* noalias align 512 "unpacked"="0.0" %dst_V_data_V, i4* noalias align 512 "unpacked"="0.1" %dst_V_keep_V, i4* noalias align 512 "unpacked"="0.2" %dst_V_strb_V, i2* noalias align 512 "unpacked"="0.3" %dst_V_user_V, i1* noalias align 512 "unpacked"="0.4" %dst_V_last_V, i5* noalias align 512 "unpacked"="0.5" %dst_V_id_V, i6* noalias align 512 "unpacked"="0.6" %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias %src) unnamed_addr #3 {
entry:
  %0 = icmp eq %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %src, null
  br i1 %0, label %ret, label %copy

copy:                                             ; preds = %entry
  call fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>.55"(i32* align 512 %dst_V_data_V, i4* align 512 %dst_V_keep_V, i4* align 512 %dst_V_strb_V, i2* align 512 %dst_V_user_V, i1* align 512 %dst_V_last_V, i5* align 512 %dst_V_id_V, i6* align 512 %dst_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* nonnull %src)
  br label %ret
...
; Function Attrs: argmemonly noinline willreturn
define internal fastcc void @"streamcpy_hls.p0class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>.55"(i32* noalias nocapture align 512 "unpacked"="0.0" %_V_data_V, i4* noalias nocapture align 512 "unpacked"="0.1" %_V_keep_V, i4* noalias nocapture align 512 "unpacked"="0.2" %_V_strb_V, i2* noalias nocapture align 512 "unpacked"="0.3" %_V_user_V, i1* noalias nocapture align 512 "unpacked"="0.4" %_V_last_V, i5* noalias nocapture align 512 "unpacked"="0.5" %_V_id_V, i6* noalias nocapture align 512 "unpacked"="0.6" %_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nocapture) unnamed_addr #4 {
entry:
...
declare void @apatb_sobel_filter_hw(i32* %input_V_data_V, i4* %input_V_keep_V, i4* %input_V_strb_V, i2* %input_V_user_V, i1* %input_V_last_V, i5* %input_V_id_V, i6* %input_V_dest_V, i32* %output_V_data_V, i4* %output_V_keep_V, i4* %output_V_strb_V, i2* %output_V_user_V, i1* %output_V_last_V, i5* %output_V_id_V, i6* %output_V_dest_V, i32 %rows, i32 %cols)
...
declare void @sobel_filter_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* noalias nonnull, i32, i32)

define void @sobel_filter_hw_stub_wrapper(i32* %input_V_data_V, i4* %input_V_keep_V, i4* %input_V_strb_V, i2* %input_V_user_V, i1* %input_V_last_V, i5* %input_V_id_V, i6* %input_V_dest_V, i32* %output_V_data_V, i4* %output_V_keep_V, i4* %output_V_strb_V, i2* %output_V_user_V, i1* %output_V_last_V, i5* %output_V_id_V, i6* %output_V_dest_V, i32 %rows, i32 %cols) #5 {
entry:
  %0 = call i8* @malloc(i64 12)
  %1 = bitcast i8* %0 to %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"*
  %2 = call i8* @malloc(i64 12)
  %3 = bitcast i8* %2 to %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"*
  call void @copy_out(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %1, i32* %input_V_data_V, i4* %input_V_keep_V, i4* %input_V_strb_V, i2* %input_V_user_V, i1* %input_V_last_V, i5* %input_V_id_V, i6* %input_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %3, i32* %output_V_data_V, i4* %output_V_keep_V, i4* %output_V_strb_V, i2* %output_V_user_V, i1* %output_V_last_V, i5* %output_V_id_V, i6* %output_V_dest_V)
  call void @sobel_filter_hw_stub(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %1, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %3, i32 %rows, i32 %cols)
  call void @copy_in(%"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %1, i32* %input_V_data_V, i4* %input_V_keep_V, i4* %input_V_strb_V, i2* %input_V_user_V, i1* %input_V_last_V, i5* %input_V_id_V, i6* %input_V_dest_V, %"class.hls::stream<hls::axis<ap_int<32>, 2, 5, 6, '8', false>, 0>"* %3, i32* %output_V_data_V, i4* %output_V_keep_V, i4* %output_V_strb_V, i2* %output_V_user_V, i1* %output_V_last_V, i5* %output_V_id_V, i6* %output_V_dest_V)
  call void @free(i8* %0)
  call void @free(i8* %2)
  ret void
}
